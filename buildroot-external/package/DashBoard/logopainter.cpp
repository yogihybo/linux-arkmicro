...
LogoPainter::LogoPainter(QWidget *parent) : QOpenGLWidget(parent)
{
    angle = -126.0;
    //angle=0;
    pix = QPixmap(":/images/SpeedRateBackGround.png");
...
void LogoPainter::resizeGL(int width, int height)
{

}

void LogoPainter::paintGL()
{
    QPainter painter;
    painter.begin(this);
    painter.fillRect(QRect(0,0,width(),height()), Qt::black);
    painter.drawPixmap(0,0,pix);
    painter.translate(314,374);  //移动到一个圆心
