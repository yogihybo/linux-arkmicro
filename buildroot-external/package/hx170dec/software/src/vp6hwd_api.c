...
VP6DecRet VP6DecGetInfo(VP6DecInst decInst, VP6DecInfo * pDecInfo)
{
    ...
    if(GetDecRegister(pDecCont->vp6Regs, HWIF_DEC_OUT_TILED_E))
    {
    ...
    pDecInfo->width = pDecCont->pb.HFragments * 8;
    pDecInfo->height = pDecCont->pb.VFragments * 8;
                            ...
                            VP6DecPicture * pOutput, u32 endOfStream)
{
    ...
    if (picForOutput)
    {
        ...
        pOutput->picWidth = pDecCont->width;
        pOutput->picHeight = pDecCont->height;
