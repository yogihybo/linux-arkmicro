...
#define VP6_SCALE_OTHER                     3
    ...
    typedef struct VP6DecInfo_
    {
        u32 vp6Version;
        u32 vp6Profile;
        u32 width;           /* coded width */
        u32 height;          /* coded height */
        u32 scaledWidth;     /* width of the displayed video */
        u32 scaledHeight;    /* height of the displayed video */
    ...
    {
        u32 picWidth;        /* pixels width of the frame as stored in memory */
        u32 picHeight;       /* pixel height of the frame as stored in memory */
