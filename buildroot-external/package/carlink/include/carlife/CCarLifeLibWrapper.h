...
=======================================================*/
	...
	int connectionSetupEap();
	int connectionSetupAOA(int idVendor);
	bool InitializeAOA();
	bool FreeEap();
	bool FreeAOA();
	bool CloseSocket();
...
//	void cmdRegisterMDBTPairInfro(void (*pFunc)(S_BT_PAIR_INFO*));
	void cmdRegisterMDBTPairInfro(void (*pFunc)(S_MD_BT_PAIR_INFO*));
...
==============================================================*/
	...
	static void* ThreadHeartBeat(void *me);
/*=============================================================
...
==============================================================*/
	...
	int EapHeadReceiveOperation();
	int AoaHeadReceiveOperation();
private:
	CCarLifeLib();
