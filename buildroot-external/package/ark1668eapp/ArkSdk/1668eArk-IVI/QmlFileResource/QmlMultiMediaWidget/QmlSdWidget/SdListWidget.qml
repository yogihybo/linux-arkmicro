...
Item {
    ...
    signal  sdMusicListviewItemClicked(int type,int index)
    FocusScope {
        id:focusScope
        x:20
        y:40
    ...
    ListView{
        id:listView
        model:mySdMusicListModelData.getObjectModel()
        ...
        delegate:Rectangle{
            ...
            MouseArea{
                ...
                onClicked: {
                    ...
                    root.sdMusicListviewItemClicked(0,index)
    ...
    onListViewCurrentIndexChanged: {
        ...
        console.log("+++++++++Music Sd Listview count++++++++++++",listView.count);
        if(listView.count > 0)
        {
            console.log("+++++++++Music Sd Listview first music name++++++++++++",listView.itemAtIndex(0).musicNameText);
        }
    }
