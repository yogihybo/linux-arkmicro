...
Item {
    ...
    Button{
        ...
        Image{
            id:btn1Icon
            anchors.fill:parent
            source: "qrc:/images/PhoneLink/AutoNormal.png"
        }
        onPressed: btn1Icon.source = "qrc:/images/PhoneLink/AutoPress.png"
        onReleased:btn1Icon.source = "qrc:/images/PhoneLink/AutoNormal.png"
    }
    Text{
        id:btn1Name
        anchors.left: parent.left
