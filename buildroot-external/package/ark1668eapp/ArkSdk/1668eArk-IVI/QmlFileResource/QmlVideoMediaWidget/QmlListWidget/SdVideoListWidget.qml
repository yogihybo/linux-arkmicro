...
Item {
    ...
    ListView{
        ...
        model:mySdVideoModelData.getObjectModel()
        width: 480
        height: 638
        clip: true
        focus: true
    ...
    onListViewCurrentIndexChanged: {
        ...
        console.log("+++++++++video SD Listview count++++++++++++",listView.count);
        if(listView.count > 0)
        {
            console.log("+++++++++video SD Listview first video name++++++++++++",listView.itemAtIndex(0).videoNameText);
        }
    }
}
