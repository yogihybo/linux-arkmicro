...
Item {
    ...
    signal  videoListviewItemClicked(int index)
    ListView{
        id:listView
        ...
        model:myUsbVideoModelData.getObjectModel()
        width: 480
        height: 638
        //highlight: Rectangle { color: "#FFFFFF"; opacity: 0.4; radius: 12 }
        clip: true
        focus: true
        interactive: true
        ...
        delegate:Rectangle{
            ...
            property alias videoNameText:title.text
            Text{
                id:title
            ...
            MouseArea{
                ...
                onClicked: {
                    ...
                    root.videoListviewItemClicked(index)
    ...
    onListViewCurrentIndexChanged: {
        ...
        console.log("+++++++++video Usb Listview count++++++++++++",listView.count);
        if(listView.count > 0)
        {
            console.log("+++++++++video Usb Listview first video name++++++++++++",listView.itemAtIndex(0).videoNameText);
        }
    }
}
