...
#define LEFT_ID     "numid=1,iface=MIXER,name='DAC Left  Playback Volume'"
#define RIGHT_ID    "numid=2,iface=MIXER,name='DAC Right Playback Volume'"
...
#define PAMUTE_ID   "numid=22,iface=MIXER,name='PA Mute'"
#if 0
...
public:
    ...
    int ALSAMixerOpen(int stream_name, int ctrlname);
    void ALSAMixerClose(void);
    int ArkALSADuckMixerGetVolume(void);
    void ArkALSADuckMixerSetVolume(int inVolume);
