...
signals:
    ...
    void onMusicPlayerFileArtist(const int type,QStringList artistList);
    void onMusicPlayerExit();
//    void onMusicPlayerFilePath(const int type, const QString& path);
protected slots:
...
private:
    ...
    ~MusicPlayer();
    MusicPlayerPrivate* const d_ptr;
    Q_DECLARE_PRIVATE(MusicPlayer)
};
