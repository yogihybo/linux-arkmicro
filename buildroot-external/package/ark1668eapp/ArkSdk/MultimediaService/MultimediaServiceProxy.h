...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<> videoPlayerVisible(bool flag)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(flag);
        return asyncCallWithArgumentList(QLatin1String("videoPlayerVisible"), argumentList);
    }
    ...
    inline QDBusPendingReply<> videoPlayerSetGeometry(int x,int y ,int width,int height)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(x) << qVariantFromValue(y) << qVariantFromValue(width) << qVariantFromValue(height);
        return asyncCallWithArgumentList(QLatin1String("videoPlayerSetGeometry"), argumentList);
    }
...
Q_SIGNALS: // SIGNALS
    ...
    void onVideoPlayerVisible(bool flag);
    void onSliderTouchEnable(bool flag); // dll add 20190805
    void onMusicPlayerFileArtist(int type,QStringList artistList);
