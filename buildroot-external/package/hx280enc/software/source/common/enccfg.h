 ...
 * 1 = 64-bit endianess */
#ifndef ENC8290_INPUT_SWAP_32_YUV
#define ENC8290_INPUT_SWAP_32_YUV                   1
#endif

/* The input image's 16-bit swap: 0 or 1
 * This defines the 16-bit endianess of the ASIC input YUV
 */
#ifndef ENC8290_INPUT_SWAP_16_YUV
#define ENC8290_INPUT_SWAP_16_YUV                   1
#endif

/* The input image's 8-bit swap: 0 or 1
 * This defines the byte endianess of the ASIC input YUV
 */
#ifndef ENC8290_INPUT_SWAP_8_YUV
#define ENC8290_INPUT_SWAP_8_YUV                    1
#endif

/* The input image's 32-bit swap: 0 or 1
 * This defines the 32-bit endianess of the ASIC input RGB16
 * 1 = 64-bit endianess */
#ifndef ENC8290_INPUT_SWAP_32_RGB16
#define ENC8290_INPUT_SWAP_32_RGB16                 0
#endif

/* The input image's 16-bit swap: 0 or 1
 * This defines the 16-bit endianess of the ASIC input RGB16
 */
#ifndef ENC8290_INPUT_SWAP_16_RGB16
#define ENC8290_INPUT_SWAP_16_RGB16                 1
#endif

/* The input image's byte swap: 0 or 1
 * This defines the byte endianess of the ASIC input RGB16
 */
#ifndef ENC8290_INPUT_SWAP_8_RGB16
#define ENC8290_INPUT_SWAP_8_RGB16                  0
#endif

/* The input image's 32-bit swap: 0 or 1
 * This defines the 32-bit endianess of the ASIC input RGB32
 * 1 = 64-bit endianess */
#ifndef ENC8290_INPUT_SWAP_32_RGB32
#define ENC8290_INPUT_SWAP_32_RGB32                 0
#endif

/* The input image's 16-bit swap: 0 or 1
 * This defines the 16-bit endianess of the ASIC input RGB32
 */
#ifndef ENC8290_INPUT_SWAP_16_RGB32
#define ENC8290_INPUT_SWAP_16_RGB32                 0
#endif

/* The input image's byte swap: 0 or 1
 * This defines the byte endianess of the ASIC input RGB32
 */
#ifndef ENC8290_INPUT_SWAP_8_RGB32
#define ENC8290_INPUT_SWAP_8_RGB32                  0
#endif

/* ENC8290_OUTPUT_SWAP_XX define the byte endianess of the ASIC output data.
 ...
 */
#ifndef ENC8290_IRQ_DISABLE
#define ENC8290_IRQ_DISABLE                         0
#endif
 ...
 *          AXI [1,16]
 */
#ifndef ENC8290_BURST_LENGTH
#define ENC8290_BURST_LENGTH                               16
#endif

/* SCMD burst mode disable                                                    */
/* 0 - enable SCMD burst mode                                                 */
/* 1 - disable SCMD burst mode                                                */
#ifndef ENC8290_BURST_SCMD_DISABLE
#define ENC8290_BURST_SCMD_DISABLE                         0
#endif

/* INCR type burst mode                                                       */
/* 0 - enable INCR type bursts                                                */
/* 1 - disable INCR type and use SINGLE instead                               */
#ifndef ENC8290_BURST_INCR_TYPE_ENABLED
#define ENC8290_BURST_INCR_TYPE_ENABLED                    0
#endif
...
#ifndef ENC8290_BURST_DATA_DISCARD_ENABLED
#define ENC8290_BURST_DATA_DISCARD_ENABLED                 0
#endif

/* AXI bus read and write ID values used by HW. 0 - 255 */
#ifndef ENC8290_AXI_READ_ID
#define ENC8290_AXI_READ_ID                                0
#endif

#ifndef ENC8290_AXI_WRITE_ID
#define ENC8290_AXI_WRITE_ID                               0
#endif

/* End of "ASIC bus interface configuration values"                           */

/* ASIC internal clock gating control. 0 - disabled, 1 - enabled              */
#ifndef ENC8290_ASIC_CLOCK_GATING_ENABLED
#define ENC8290_ASIC_CLOCK_GATING_ENABLED                  1
#endif

/* ASIC timeout interrupt enable/disable                                      */
#ifndef ENC8290_TIMEOUT_INTERRUPT
#define ENC8290_TIMEOUT_INTERRUPT                          1
#endif
...
/* finished.                                                                  */
#ifndef ENC8290_SLICE_READY_INTERRUPT
#define ENC8290_SLICE_READY_INTERRUPT                      1
#endif
