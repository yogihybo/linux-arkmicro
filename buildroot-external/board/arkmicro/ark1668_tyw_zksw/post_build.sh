...
UBOOT_OUTPUT_DIR=${BR2_EXTERNAL_ARK_PATH}/../output/board/ark1668_tyw_zksw/u-boot

#install modules to target
source ${BR2_EXTERNAL_ARK_PATH}/../env.source
cd ${BR2_EXTERNAL_ARK_PATH}/../output/board/ark1668_tyw_zksw/linux
...
rm -rf ${TARGET_DIR}/etc/init.d/S41dhcpcd
