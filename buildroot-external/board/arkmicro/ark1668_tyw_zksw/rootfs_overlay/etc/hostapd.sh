...
#insmod /lib/modules/4.14.88/kernel/drivers/net/wireless/realtek/bcmdhd/bcmdhd.ko
insmod /lib/modules/4.19.192/kernel/drivers/net/wireless/realtek/rtl8821cs/rtl8821cs.ko
#insmod /lib/modules/4.19.192/kernel/drivers/net/wireless/realtek/aic8800/aic8800_wifi/aic8800_wlan.ko
#sleep 1
...
udhcpd -f /etc/udhcpd.conf wlan1 &
