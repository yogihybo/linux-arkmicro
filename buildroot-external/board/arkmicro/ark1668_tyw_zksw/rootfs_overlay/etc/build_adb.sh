...
if [ $usb_idx -eq 0 ];
then
	echo peripheral > /sys/devices/platform/ahb/e0100000.usb/musb-hdrc.$usb_idx/mode
else
	echo peripheral > /sys/devices/platform/ahb/e0400000.usb/musb-hdrc.$usb_idx/mode
fi
