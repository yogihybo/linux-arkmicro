...
static const struct uvc_format2_h264 uvc_format_h264 = {
        .bLength                   =         28,
        .bDescriptorType           =        36,
        .bDescriptorSubtype        =         16 ,
        .bFormatIndex              =         2,
...
static const struct UVC_FRAME_H2642(2) uvc_frame_h264_720p = {
        ...
        .bFrameIndex              =          2 ,
        .bmCapabilities           =        0x00,
		.wWidth                   =        cpu_to_le32(1280),
        .wHeight                  =        cpu_to_le32(720),
		.dwMinBitRate             =	       cpu_to_le32(29491200),//cpu_to_le32(497664000),
        .dwMaxBitRate             =        cpu_to_le32(29491200),//cpu_to_le32(995328000),
        .dwDefaultFrameInterval   =        cpu_to_le32(400000),
        .bFrameIntervalType       =           2,
        .dwBytesPerLine           =           0,
        .dwFrameInterval[0]      =         cpu_to_le32(400000),
...
static const struct UVC_FRAME_H2642(2) uvc_frame_h264_480p = {
		.bLength                  =        UVC_DT_FRAME_H264_SIZE2(2) ,
		.bDescriptorType          =          36,
		.bDescriptorSubtype        =         17 ,
		.bFrameIndex              =          3 ,
		.bmCapabilities           =        0x00,
		.wWidth                   =        cpu_to_le32(720),
		.wHeight                  =        cpu_to_le32(480),
		.dwMinBitRate             =	  cpu_to_le32(29491200), 
		.dwMaxBitRate             =   cpu_to_le32(29491200), 
		.dwDefaultFrameInterval   =      cpu_to_le32(400000),
		.bFrameIntervalType       =           2,
