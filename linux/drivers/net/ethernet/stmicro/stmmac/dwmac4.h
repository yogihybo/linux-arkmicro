...
#define GMAC_HI_DCS			GENMASK(16, 16)
#else
...
#ifdef CONFIG_SOC_ARK1668E
#define MTL_RXQ_DMA_Q04MDMACH_MASK	GENMASK(0, 0)
#define MTL_RXQ_DMA_Q04MDMACH(x)	((x) << 0)
#define MTL_RXQ_DMA_QXMDMACH_MASK(x)	GENMASK(8 + (8 * ((x) - 1)), 8 * (x))
#else
...
#ifdef CONFIG_SOC_ARK1668E
#define MTL_OP_MODE_TQS_MASK		GENMASK(19, 16)
#else
...
#ifdef CONFIG_SOC_ARK1668E
#define MTL_OP_MODE_RQS_MASK		GENMASK(25, 20)
#define MTL_OP_MODE_RQS_SHIFT		20

#define MTL_OP_MODE_RFD_MASK		GENMASK(18, 14)
#define MTL_OP_MODE_RFD_SHIFT		14

#define MTL_OP_MODE_RFA_MASK		GENMASK(12, 8)
