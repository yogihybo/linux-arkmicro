 ...
 *
 *****************************************************************************/
#ifndef _RTL8822EU_HAL_H_
#define _RTL8822EU_HAL_H_
	...
	/* rtl8822eu_ops.c */
	void rtl8822eu_set_hal_ops(PADAPTER padapter);
	void rtl8822eu_set_hw_type(struct dvobj_priv *pdvobj);

	/* rtl8822eu_io.c */
	void rtl8822eu_set_intf_ops(struct _io_ops *pops);

#endif /* CONFIG_USB_HCI */


#endif /* _RTL8822EU_HAL_H_ */
