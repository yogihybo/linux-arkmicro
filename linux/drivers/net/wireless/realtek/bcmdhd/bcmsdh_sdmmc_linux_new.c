...
static const struct sdio_device_id bcmsdh_sdmmc_ids[] = {
	...
	{ SDIO_DEVICE_CLASS(SDIO_CLASS_NONE)		}, /* dummy_sdmmc_driver driver can't be probe without this and cause bring up failed */
                              ...
                              const struct sdio_device_id *id)
{
	...
	if (id) {
		...
		/* dummy_probe: func->num=0x2; 
		  * dummy_probe: class=0x0; vendor=0xffff; device=0xffff
		  * dummy_probe can't get correct vendor id, if return -ENODEV, will terminate driver loading on I.MX6SX
		  * TODO: 1.363 branch also don't include this code, don't why it can work with BU machine???
