...
#define __PHYDM_FEATURES_CE_H__
	 ...
	 RTL8822C_SUPPORT || RTL8723F_SUPPORT || RTL8822E_SUPPORT)
	...
	#define DYN_ANT_WEIGHTING_SUPPORT
	 ...
	 RTL8814B_SUPPORT || RTL8723F_SUPPORT || RTL8822E_SUPPORT)
	#define FAHM_SUPPORT
#endif

#if (RTL8822C_SUPPORT || RTL8723F_SUPPORT || RTL8822E_SUPPORT)
...
#if (RTL8822C_SUPPORT || RTL8814B_SUPPORT || RTL8822E_SUPPORT)
...
/*@#define PHYDM_TDMA_DIG_SUPPORT*/
	...
	RTL8822C_SUPPORT || RTL8723D_SUPPORT || RTL8822E_SUPPORT|| RTL8188F_SUPPORT)
...
#if (RTL8822C_SUPPORT || RTL8814B_SUPPORT || RTL8723F_SUPPORT || RTL8822E_SUPPORT)
...
#if (RTL8822B_SUPPORT || RTL8723F_SUPPORT) //RTL8821C_SUPPORT //RTL8822C_SUPPORT //RTL8822E_SUPPORT
...
#if (RTL8822B_SUPPORT || RTL8822C_SUPPORT || RTL8192F_SUPPORT || RTL8822E_SUPPORT)
...
#define CFG_DIG_DAMPING_CHK
		...
		#define	PHYDM_BEAMFORMING_VERSION1
	     ...
	     RTL8822C_SUPPORT || RTL8814B_SUPPORT || RTL8822E_SUPPORT)
		#define	DRIVER_BEAMFORMING_VERSION2
	#endif
#endif

#if (RTL8822B_SUPPORT || RTL8822C_SUPPORT || RTL8822E_SUPPORT)
