...
struct net_device *rtw_init_netdev(_adapter *old_padapter)
{
	 ...
	 * HW-confirmed crash: "Unable to handle kernel NULL pointer dereference
	 * at virtual address 00000fc8" in rtw_dfs_rd_en_decision, from
	 * disconnect_hdl -> rtw_mlmeext_disconnect -> rtw_dfs_rd_en_dec_on_mlme_act,
	 * during hostapd AP startup. Confirmed identical, equally-missing line in
	 * rtl8821cs's copy of this same file -- a genuine upstream vendor SDK
	 * bug, not something introduced by porting this file to the USB build. */
