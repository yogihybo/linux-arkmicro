 ...
 *
 *****************************************************************************/
#ifndef _RTL8822E_HAL_H_
#define _RTL8822E_HAL_H_
 ...
 */
#define REG_AFE_XTAL_CTRL	REG_AFE_CTRL1_8822E	/* hal_com.c & phydm */
#define REG_LEDCFG0		REG_LED_CFG_8822E	/* rtw_mp.c */
#define MSR			(REG_CR_8822E + 2)	/* rtw_mp.c & hal_com.c */
#define MSR1			REG_CR_EXT_8822E	/* rtw_mp.c & hal_com.c */
#define REG_C2HEVT_MSG_NORMAL	0x1A0			/* hal_com.c */
#define REG_C2HEVT_CLEAR	0x1AF			/* hal_com.c */
#define REG_BCN_CTRL_1		REG_BCN_CTRL_CLINT0_8822E	/* hal_com.c */

#define REG_WOWLAN_WAKE_REASON	0x01C7 /* hal_com.c */
#define REG_GPIO_PIN_CTRL_2		REG_GPIO_EXT_CTRL_8822E		/* hal_com.c */
...
#define RXERR_COUNTER_MASK		BIT_MASK_RPT_COUNTER_8822E
#define RXERR_RPT_RST			BIT_RXERR_RPT_RST_8822E
#define _RXERR_RPT_SEL(type)		(BIT_RXERR_RPT_SEL_V1_3_0_8822E(type) \
					| ((type & 0x10) ? BIT_RXERR_RPT_SEL_V1_4_8822E : 0))
...
#define rHSSIRead_Jaguar		0x8B0	/* RF read addr (rtl8822e_phy.c) */
...
/* TX BeamForming */
#define REG_BB_TX_PATH_SEL_1_8822E	0x93C	/* rtl8822e_phy.c */
#define REG_BB_TX_PATH_SEL_2_8822E	0x940	/* rtl8822e_phy.c */

/* TX BeamForming */
#define REG_BB_TXBF_ANT_SET_BF1_8822E	0x19AC	/* rtl8822e_phy.c */
#define REG_BB_TXBF_ANT_SET_BF0_8822E	0x19B4	/* rtl8822e_phy.c */
...
#define rA_PIRead_Jaguar		0xD04	/* RF readback with PI (rtl8822e_phy.c) */
#define rA_SIRead_Jaguar		0xD08	/* RF readback with SI (rtl8822e_phy.c) */
#define rB_PIRead_Jaguar		0xD44	/* RF readback with PI (rtl8822e_phy.c) */
#define rB_SIRead_Jaguar		0xD48	/* RF readback with SI (rtl8822e_phy.c) */
...
#define RF_CHNLBW		0x18	/* rtl8822e_phy.c */
#define RF_ModeTableAddr	0x30	/* rtl8822e_phy.c */
#define RF_ModeTableData0	0x31	/* rtl8822e_phy.c */
#define RF_ModeTableData1	0x32	/* rtl8822e_phy.c */
#define RF_0x52			0x52
#define RF_WeLut_Jaguar		0xEF	/* rtl8822e_phy.c */

/* rtw_lps_state_chk()@hal_com.c */
#define BIT_PWRBIT_OW_EN	BIT_WMAC_TCRPWRMGT_HWDATA_EN_8822E 

/* General Functions */
void rtl8822e_init_hal_spec(PADAPTER);				/* hal/hal_com.c */

#ifdef CONFIG_MP_INCLUDED
/* MP Functions */
#include <rtw_mp.h>		/* struct mp_priv */
void rtl8822e_prepare_mp_txdesc(PADAPTER, struct mp_priv *);	/* rtw_mp.c */
void rtl8822e_mp_config_rfpath(PADAPTER);			/* hal_mp.c */
#endif
void hw_var_set_dl_rsvd_page(PADAPTER adapter, u8 mstatus);

#ifdef CONFIG_USB_HCI
#include <rtl8822eu_hal.h>
#elif defined(CONFIG_SDIO_HCI)
#include <rtl8822es_hal.h>
#elif defined(CONFIG_PCI_HCI)
#include <rtl8822ee_hal.h>
#endif

#endif /* _RTL8822E_HAL_H_ */
