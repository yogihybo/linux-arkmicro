...
struct uvc_format2_h264
{
    __u8 bLength;						// 28
    __u8 bDescriptorType;				// 36
    __u8 bDescriptorSubtype;			// 16 (FORMAT_FRAME_BASED)
    __u8 bFormatIndex;					// 2
    __u8 bNumFrameDescriptors;
    __u8 guidFormat[16];
    __u8 bBitsPerPixel;
...
#define UVC_DT_FRAME_H264_SIZE2(n)			(26+4*(n))

#define UVC_FRAME_H2642(n) \
	uvc_frame_h2642_##n
#define DECLARE_UVC_FRAME_H2642(n)			\
struct UVC_FRAME_H2642(n) {				\
        __u8 bLength            ;         \
        __u8 bDescriptorType      ;        \
        __u8 bDescriptorSubtype     ;     \
        __u8 bFrameIndex            ;      \
...
struct UVC_FRAME_H264(n) {				\
    ...
    __u32 bmMaxSVCCapabilities;\
	__u32 bmMaxMVCCapabilities;\
	__u32 dwMinBitRate;\
    __u32 dwMaxBitRate;\
    __u32 dwDefaultFrameInterval;\
